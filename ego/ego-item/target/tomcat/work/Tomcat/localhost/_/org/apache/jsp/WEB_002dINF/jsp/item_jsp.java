 ...
 * Generated at: 2017-08-17 01:20:51 UTC
...
public final class item_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(".html\" onclick=\"javascript:location.href='http://localhost:8085/cart/add/");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${item.id}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write(".html?num='+$('#buy-num').val();return false;\" clstag=\"shangpin|keycount|product|initcarturl\">加入购物车<b></b></a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<!-- 商品描述：同样这个地方也是存储在作用域中的数据。 -->\r\n");
      out.write("\t\t\t\t\t\t");
      out.write("</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t},\r\n");
      out.write("\t\t\t//请求商品描述，异步请求。\r\n");
      out.write("\t\t\tgetItemDesc:function(itemId) {\r\n");
      out.write("\t\t\t\t$.get(itemControl.param.descUrl+itemId+\".html\", function(data){\r\n");
      out.write("\t\t\t\t\t//返回商品描述的html，直接显示到页面将后天查询到的数据追加到前台页面显示。\r\n");
      out.write("\t\t\t\t\t//data :接收后台传过来的getDesc();商品描述。append。将商品描述追加到div标签显示\r\n");
      ...
      out.write("\t\t\t\t\t\t//返回商品规格的html，直接显示到页面，data同样也是回调函数，将后台返回的数据交给前台页面显示。\r\n");
